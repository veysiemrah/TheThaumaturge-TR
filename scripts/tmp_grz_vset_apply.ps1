# GRZ vset CSV'leri apply et — yalnızca grz_vset_* / GRZ_vset_* dosyalarını işler.
...
# Hem küçük hem büyük harf prefix
$csvs = @(Get-ChildItem $csvDir -Filter "grz_vset_*.csv" -File) + @(Get-ChildItem $csvDir -Filter "GRZ_vset_*.csv" -File) | Sort-Object Name -Unique
