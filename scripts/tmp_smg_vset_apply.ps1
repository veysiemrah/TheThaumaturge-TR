# SMG vset CSV'leri apply et — yalnızca smg_vset_* / SMG_vset_* dosyalarını işler.
...
$csvs = @(Get-ChildItem $csvDir -Filter "smg_vset_*.csv" -File) + @(Get-ChildItem $csvDir -Filter "SMG_vset_*.csv" -File) | Sort-Object Name -Unique
