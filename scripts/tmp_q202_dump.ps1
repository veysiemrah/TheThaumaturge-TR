# tmp_q202_dump.ps1
# q202 + q203 tüm .uasset'leri JSON'a çevir + PL CSV dump üret.

$uaGui = ".\tools\UAssetGUI\UAssetGUI.exe"
$mappings = "Mappings"

$targets = @(
    @{ Quest = "q202"; Extract = "build\q202_extract"; Json = "build\q202_json" },
    @{ Quest = "q203"; Extract = "build\q203_extract"; Json = "build\q203_json" }
)
