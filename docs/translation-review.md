...
| 2026-04-19 | Yedinci tur — Exploration_ST tam + LW/POI spot + q102_00b Ligia grimuar | Exploration_ST (108 entry — UI etkileşim, zaman dilimleri, dialog pride/Kibir response'ları), lw_POI_SMG_ladyD (5), lw_POI_SMC_Postcard_ImperialHotel (4), lw_pw01_journal (11), q102_00b_ligia_about_grimoire (65 satır — Wiktor-Ligia-Wujek grimuar+baba ölümü sahnesi). Çapraz tarama: Zotiye/buruklukluk/Hakâret/çağırtt/Polonyaca/Berek (tümü artık sıfır). | **1 düzeltme deploy'lu:** q102_00b:32 "iki çocuk babam tarafından dünyanın en büyük **beladırmış** gibi muamele gördü" → "**belalarıymış** gibi" (PL "zakały tego świata" = dünyanın belaları; TR'de gramer hatası — çoğul iyelik eki eksikti). Exploration_ST (Laterna/Balalayka/Pierogi/Hallah/Likör/Absent dönem tınısı + Kibir/Duma response'ları) ve LW/POI spot ✅ temiz. Proje genelindeki tüm yaygın hata pattern'ları (Zotiye, buruklukluk, Hakâret, çağırtt, Polonyaca, Berek, Ohrana) artık **sıfır** — önceki turlarda düzeltilen hataların başka bir yerde tekrarı yok. |
| 2026-04-19 | Sekizinci tur — q103/q102 büyük dialog spot (parti+aftermath+Abaurycy intro) | q103_03a_ligia_party (108 satır — sosyete parti, Puchalski boynuz, Abaurycy çocukluk, Ligia ironi), q102_06a_aftermath (54 satır — Abaurycy sarhoş şiir parodisi, Satanisław wordplay, Ligia borç), q102_02a_london_bar_intro (120 satır — Wiktor kaçırılma sahnesi, Niedzic Mojki'ler, Kazak saldırısı). | **1 düzeltme deploy'lu:** q102_02a:28 "Her şey **haltoldu**" → "Her şey **boka sardı**" (birleşik yazım hatası; "halt oldu" TR'de yerleşik bir deyim değil — gangster karakter sesine de uygun kaba argoya çevrildi). q103_03a sosyete diyalogu (Ligia-Puchalski-Głogowski, Wujek şirket konusu, Zofia Skałon bahis), q102_06a Abaurycy sarhoş parodi + Satanisław/Stanisław wordplay + Ligia ironi, q102_02a gangster-Kazak aksiyon ✅ karakter sesi + argo + Fransızca/Rusça tag'ler tutarlı. |
| 2026-04-19 | Dokuzuncu tur — q102_00c/00d + q103_00a (giriş sahneleri) | q103_00a_ligia_in_living_room (30 — Ligia Wiktor'u davet için hazırlıyor), q102_00c_ligia_bedroom (78 — Ligia pantolon/sigara/Swietłana/grimuar konuşması), q102_00d_grazyna_kitchen (33 — Grażyna kakao/likör sahnesi, Stanisław ölümü dedikodusu), q102_04a_art_bar spot (80 satır — Abaurycy sanat bar, Meukow konyak, Mojki şair). | **1 düzeltme deploy'lu:** q102_00d:23 "Küçük efendim kötücül güçlerin bunda parmağı olmadığını mı düşünüyor?" → "Küçük efendim, bu işte kötücül güçlerin parmağı olduğunu düşünmüyor mu?" (**çift negatif çeviri hatası** — PL "Nie sądzi panicz, że jakieś siły nieczyste w tym palcy nie maczały?" Lehçe idiomatik çift negatif; TR'de "olmadığını mı" anlamı tam tersine çevirmişti — Grażyna Wiktor'a kötücül güçlerin **olabileceği** fikrini öneriyor). Diğer asset'ler ✅ temiz — karakter sesi (Ligia-Wujek aile samimiyeti, Grażynka köylü aristokrat bakış, Abaurycy şair maskesi), glossary + dönem tonu + tag/placeholder tutarlı. |
| 2026-04-19 | Onuncu tur — q103_01b Rasputin + q102_01a/03b (kaçırılma+Kazaklar) + genel pattern taraması | q103_01b_rasputin_and_aniela (80 — Rasputin hipnoz seansı, Aniela tanışma, Titanic/I.DS kehanet vizyonları), q102_01a_kidnapping (8 — çok kısa, kaçırma başlangıcı), q102_03b_cossacks_outside (35 — Kazaklar sokak lambasına saldırı, bar sahnesi). Genel yazım pattern taraması: degil/guzel/boyle/soyle (diakritiksiz yazımlar) + değil/olmadığını/mısın patterns. | **1 düzeltme deploy'lu:** q102_03b:26 "İşi hakkiyle **halletiniz**" → "İşi **hakkıyla hallettiniz**" (iki TR yazım hatası birlikte: hakkiyle→hakkıyla ı/i ayrımı, halletiniz→hallettiniz çift t eksikti). Diğer asset'ler ✅ — q103_01b Titanic/I. Dünya Savaşı kehaneti Notes ile açıklı, Rasputin hipnoz sahnesi tutarlı, Kazak-Abaurycy sarhoş sokak lambası güreşi sahnesi karakter sesi mükemmel. Genel diakritiksiz yazım taraması tüm projede sıfır.
| 2026-04-21 | q201 + q201b yeni çeviri (review değil) | 47 asset / ~2064 satır — q201 Assets (10), q201 Chats (14), q201b Assets (9), q201b Chats (14). Ayrıca 2 eski tırnaksız CSV satırı düzeltildi (q102_00d_grazyna_kitchen:23, q104_00b_bar_chat:3 — validator raporuna göre). | Deploy 22:50. Sonraki review turu: q201 Mordechaj/Chajat derinlik + Ariel Rofe argosu + Berur ritüeli tutarlılığı bekleniyor. Yeni özel isimler glossary'ye eklendi: Mordechaj Feldman, Mordechaj Chajat, Ariel Rofe, Abraham Horowitz, pani Jagoda, Izaak Sofer, Berur ritüeli, Uçan Üniversite, Nożyk sinagogu, Marszałkowska, Kierbedź, Ciechocinek, Altın Ördek, Bimber, Pralnia, Masarnia. |
| 2026-04-20 | q202 + q203 yeni çeviri (review değil) | 41 asset / ~1874 satır — q202 Assets (14 dahil Fałdżej 195-satır + Konieczkin Fort 138 + Samira Fort 134 hipnoz), q202 Chats (7 dahil Âmentü duası), q203 Assets (16 dahil Rasputin cemetery 180 + miracle_part2 156 + afterparty_part2 166 + orgy 97 + hipnoz salutor sekansları), q203 Chats (4). | Deploy 00:18. Yeni özel isimler glossary'ye eklendi: Emir Burnakowicz, Jan Białek, Michał, Sara Rywkin, Aniela+Lucjan Nadarzyński, Lazarew, Szymon/Szymek, Patrik Kirył, Aleksy Romanow, Çariçe Aleksandra, Pankracy, Aya Maria Magdalena kilisesi, Sacré-Cœur, fałdżej (ünvan). Tarihsel/dinsel metinler: Âmentü duası (Fałdżej Michał için), Selanikliler 5:7+5:14 alıntıları, Vaiz 1:2, Başmelek Mikail Latin duası, Selanikliler İncil göndermeleri, Süleyman'ın Meselleri göndermeleri korundu. Sonraki review: q202 Fałdżej gizli toplantı derinlik (Emir+Cemiyet+Kara Grimuar), q203 Rasputin-Rasputin seksek mantığı + egzorsizm sahnesi tutarlılık bekleniyor. |
| 2026-04-25 | On birinci tur — yeni asset glossary regresyon taraması (q201–q401, lw_*, GenericEncounters, Global_chats) | Çapraz Grep: Pakt/paktı/Paktımız (16 dosya), Ohrana, Komitywa, Polonyaca, Hotel, Doktor, Berek, diakritiksiz yazımlar. Son review (2026-04-19) sonrası eklenen ~250 asset'te glossary tutarlılık denetimi. | **32 düzeltme deploy'lu (10 dosya):** **Pakt → Ant (17 yer):** q301_00a_faldzej_and_samira (3), q301_02_committee_assemble (8 — yemin sahnesi, Sara Rywkin x2, Emir, "pakt bağını taçlandırmak"→"Ant'ı taçlandırmak"), q301_03b_faldzej_ball (2), q301_03d_samira_ball (1), q301_03j_skalon_part2 (1), q301_04a_committee_tsar (1). **Ohrana → Ochrana (9 yer):** genenc_bzr_05 (3), grz01_03b_pimp (5 dahil Notes), smg02_00a_ligia_about_lecture (1) — önceki review'da düzeltilmişti, yeni asset'lerde regresyon. **Doktor → Hekim (4 yer):** genenc_bzr_05 — fałdżej Burnakowicz'in tıbbi rolü (glossary "diyalogda hekim"). **konował → şarlatan (2 yer):** genenc_pr_02 — Lehçe aşağılayıcı "şarlatan/sözde hekim" doğru çevirisi (önceki TR "doktor" bağlamı kaybediyordu). Tüm Pakt sahneleri Cemiyet kuruluşuyla bağlantılı (Bölüm 3 büyük yemin/komitywa toplantısı), glossary ihlali oyunun en kritik tematik anında olabilirdi. Diğer pattern (Komitywa, Polonyaca, Berek, diakritiksiz, Hotel) sıfır — temiz. |
| 2026-04-25 | On ikinci tur — TR-sütun üç nokta tutarlılığı (`...` → `…`) | `scripts/find_tr_triple_dots.ps1` ile proje genelinde TR sütununda ASCII `...` taraması: 697 hit / 95 dosya. Glossary "TR sütununda … tercih edilir" kuralının kümülatif regresyonu — son aylarda eklenen tüm yeni asset'lerde (q201–q401, lw_*, GenericEncounters, smg02, Global_chats) ve hatta eski q102/q103 sahnelerinde tutarsızlık. | **791 düzeltme deploy'lu (165 dosya):** Yeni `scripts/fix_tr_triple_dots.ps1` script'i Import-Csv tabanlı, TR sütununda `...` → `…` (U+2026) yapıyor; PL kolonu kaynaktır, dokunulmaz. Etkilenen kategoriler: tüm dialog asset'leri (q001/q101/q102/q103/q104/q201/q201b/q202/q203/q301/q302), Codex DT (CodexCharactersDT, CodexLocationsDT, CodexFactionsDT, CodexLoreDT), readables (q102/q103/q104/lw_smg01/SMC/PP), GenericEncounters (45/45), LivingWorld (lw_smg02 Uçan Üniversite + 3 berber + lw_grz01 + lw_smg04), Global_chats (5/5), DD_* (Default), q001 chats. Yüksek hit'li tematik sahneler: q301_02_committee_assemble (39 yer — Cemiyet yemin), q302_03e_tsar_speech (34 — Çar konuşması), q102_02d_london_bar_abaurycy (28 — Abaurycy gangster argo), q102_02a_london_bar_intro (25 — Wiktor kaçırılma), q102_00b_ligia_about_grimoire (22 — Wiktor-Ligia-Wujek grimuar), q301_01b_rofe (24 — Rofe ölüm yatağı dramı), q301_01c_old_woman (13 — Tadzik anne dehşet). Validate sonrası TR-`...` hit sayısı: **0**. Yeni `scripts/fix_tr_triple_dots.ps1` ileride sürekli check için kalıcı; `scripts/find_tr_triple_dots.ps1` raporlama scripti pipeline'a eklenebilir. Pak: 15.70 MB. |
| 2026-04-25 | On üçüncü tur — q401/q302 oyun finali derinlik + Naczelnik regresyon taraması | q401_03b_tsar (Çar audience, Krovavyy taumaturg, Luka 16:10 İncil), q401_05_committee (Skałon Tworki tımarhanesi, Lechitler/Antitaumaturg/PPS yeni faşistler, Yidiş küfür tonu), q401_02a_abaurycy (Külkedisi/balkabağı, Üç Silahşor Aramis, Hacı/Yerli, Şek Şük), q302_02d_konieczkin_death (Konieczkin'in ölümü — kritik!) derin spot. Çapraz `naczelnik` Polonyaca tarama. | **9 düzeltme deploy'lu (5 dosya):** **Naczelnik → Amir / amir bey (8 yer):** PL "naczelnik Ochrany"/"panie naczelniku" yeni asset'lerde Polonyaca kalmıştı (önceki review'larda ImprintsDescription_ST + q104_05a referans olarak "Amir/amir bey" yapılmıştı; q302/q201 yeni sahnelerde regresyon). q302_02d_konieczkin_death:11 (Ligia Wiktor'a "Az önce evimde Ochrana amirini mi vurdun?"), q302_02b_family_talk:3+103 (Grażyna telefon önerisi), q302_02c_burying_konietchkin_chat:8 (Niedzic ironik "huzur içinde yat, amir bey"), q302_02e_final_decision:56 ("Niedzic Ochrana amirini öldürdü"), q302_02c_konieczkin_arrival:30/37/39/57 (4 yer "panie naczelniku" → "amir bey"). **Okhrana → Ochrana (1 yer, DD_ligia:42):** Önceki Ochrana tutarlılık turuna rağmen burada "Okhrana" kalmıştı. q401 oyun finali asset'leri (Paris epilog, Çar audience, Cemiyet veda) genel olarak ✅ temiz — Külkedisi/Cinderella, Aramis, Hacı/Yerli, Şek Şük, Yidiş tonu, Tworki tımarhanesi, Krovavyy taumaturg lakabı, Luka İncil alıntısı, glossary tutarlı. Pak: 15.70 MB, deploy 03:34. |
| 2026-04-25 | On dördüncü tur — sq001 vizyonlar + lw_smg04 Polina/sorgu derinlik | sq001 7 vizyon (Upyr 00, 7. yaş günü 01, kilise atkısı 02, Baltık 03, grimuar 04, Abaurycy babası 05, Mieszko Secemin 06 — Wiktor'un Kibir Kusur kaynağı), lw_smg04_01b_interrogation (Ochrana sorgu, Hamlet/Rosencrantz/Ofelya, çekiç-kerpeten, strzyga, "manto"/bir güzel pataklamak), lw_smg04_04a_young_woman (Polina kumar sahnesi, Wiesław küfür, kacapska sierota, krewna borçlu argosu), lw_smg04_04b_gamblers_quarell (Rusça `<ru>` tag'ler, askerlerden kaçış). | **1 yazım düzeltmesi deploy'lu (1 dosya):** lw_smg04_04a_young_woman:26 — Wiesław küfürü "<i>żłobie, w mordę orany</>" çevirisinde "**sürat** pulluğuyla sürülmüş" yazım hatası → "**suratı** pullukla sürülmüş" (PL "w mordę orany" = yüzü pullukla sürülmüş gibi çirkin; tek harf hatası anlamı bozuyordu). sq001 ✅ temiz — tüm 7 vizyon glossary tutarlı (Pakt → Ant, Duma → Kibir, Skaza → Kusur, ikiz bağı, tılsımkâr, stuła → papaz atkısı, Praga); Wiktor'un pişman + alaycı tonu güzel; çift boşluk gibi kaynak tipoları korunmuş. lw_smg04 sorgu/kumar sahneleri ✅ temiz — küfür/argo (ćwoku zapierdziany, kacapska sierota, Dymaj, manto, chojracz, łachmyto, krewna), kültürel göndermeler (Hamlet, strzyga), `<ru>` tag'ler (Shto eto znachit, Polyaki, ponyal) hepsi tutarlı. Pak: 15.70 MB, deploy 03:43. |
| 2026-04-25 | On beşinci tur — q302 büyük finali sahneleri (Çar konuşması + Wiktor rüya) derinlik | q302_03e_tsar_speech (242 satır — Çar audience, Çariçe Aleksandra/Aleksiej carewicz, Rasputin'in "diriliş", II. Mikolay 1895 konuşması alıntısı, Matta 28:20+5:3 İncil alıntıları, Yahuda metaforu, Tsarskoye Selo, kâfir köpek/akolit/mistik), q302_01c_wiktor_dream (234 satır — Wiktor baba rüyası psikolojik yargılama sahnesi, Pycha/Duma ayrımı, Skaza/Kusur sökme, Baalberith, Czarny Grymuar vasiyet, ikiz Ligia, Golem, Rasputin meşrulaştırma, vicdan üzerine mahkeme). | **3 düzeltme deploy'lu (2 dosya):** **Çift olumsuz çeviri hatası — kritik anlam tersine (q302_03e:232):** PL "Nie bez powodu uznaliście go za heretyka i szarlatana oraz usunęliście z Petersburga" ("Onu boşuna sapkın saymadınız ve sürmediniz" = boşuna değildi, sebebi vardı) → eski TR "Onu sebepsiz yere sapkın ve şarlatan saymadınız ve Petersburg'dan sürmediniz" anlamı tam tersine çeviriyordu (sanki yapmamışlar gibi). Düzeltme: "Onu sapkın ve şarlatan saymanız, Petersburg'dan sürmeniz boşuna değildi." Bu Çar konuşmasının kritik anında Wiktor'un Rasputin'i Petersburg sürgünüyle suçladığı sözdü; çift olumsuzla anlam yanlış kuruluyordu. **Yapısal yazım (q302_03e:243):** "geleceğin tahtı varisinin yanı" → "müstakbel tahta varisinin yanı" (tahtı→tahta + Lehçe "przyszły następca" → müstakbel daha doğal). **Yazım (q302_01c:140):** "Nasıl bir baba ve **kocaydığını** gördükten sonra" → "**koca olduğunu** gördükten sonra" (Wiktor babasına: "kocaydığını" Türkçe değil — büyük olasılıkla "koca idin" eski formu uyarlama hatası). q302 büyük sahneler genel olarak ✅ temiz — Rusça `<ru>` tag'ler aynen (suka, malyutka, Vashe Imperatorskoye Velichestvo, Eto chudo, Grigori Yefimovich Rasputin, ya slyshala o vas), İncil alıntıları doğru, Yahuda/Mesih/şeytan metaforları korunmuş, Wiktor "ikiz Ligia" + "yargılama" + "Pycha-Duma" psikolojik dengesi sağlam. Pak: 15.70 MB, deploy 03:47. |
| 2026-04-25 | On altıncı tur — q201–q203 Bölüm 2 derin spot (Fałdżej gizli toplantı + Rasputin "diriliş" + Konieczkin Fort) | q202_04_faldzej_secret_meeting (~196 satır — Fałdżej-Wiktor Cemiyet'in yeniden kuruluşu, Arapça `<ar>` tag'ler, Soğan/Cebula kodu, fałdżej ünvan, Sofer ölümü, Konieczkin gözetimi), q202_06a_konietchkin_fort (138 — Konieczkin Fort hipnoz sorgu, Madame Samira), q203_04b_miracle_part2 (156 — Rasputin "diriliş" mucizesi, çocuk tılsımkâr Szymek, Latince Başmelek Mikail duası "Princeps militiae Caelestis", Pater Kirył anatema). Çapraz "Szymek" özel ad tutarlılığı taraması. | **1 tutarlılık düzeltmesi deploy'lu (1 dosya):** q203_04b_miracle_part2:110 — Szymek özel adı kekemelikte "Şy-Şymek" yapılmıştı (q-203_04b:12, CodexCharactersDT, q202_06b, q203_02a tüm yerlerde "Szymek" Polonyaca formu korunuyor). Düzeltme: "Szy-Szymek" (özel ad korunur, kekeleme bile transliterasyona uğramaz). q201–q203 derinlik genel olarak ✅ temiz — Arapça selamlaşma (`<ar>As-salam alejkum</>`, `<ar>Wa'alejkum salam</>`, `<ar>Ma'a as-salama</>`), fałdżej (Tatar dini ünvan), Cebula/Soğan + Çatal/Widelec kodlar (Wanda/PPS), Latince Başmelek Mikail duası, "klecho/papaz bozuntusu" Rus aşağılaması, "anatema/aforoz" dini terim, Sofer/Stanisław/Iwan Konieczkin/Sara Rywkin/Madame Samira/Janek/Michał özel adlar tutarlı. Pak: 15.70 MB, deploy 03:51. |
| 2026-04-25 | On yedinci tur — Mikołaj Çar adı + Rzeczpospolita özel ad tutarlılığı taraması | Çapraz Grep: Mikolay/Nikolay/Mikoláy varyantları, Rzeczpospolita/Cumhuriyet, Pielgrzym/Tuziemiec, Cytadela/Sitadel. Proje %95 "Mikołaj" (Polonyaca form, CodexCharactersDT/q101_readable/q302_01c gibi tüm Codex/readable'larda) lehine; ancak 6 yerde TR'de Mikolay/Nikolay sapması tespit. | **7 düzeltme deploy'lu (6 dosya):** **Mikolay/Nikolay → Mikołaj (6 yer):** Achievements_ST:74 (q401 başarımı "II. Nikolay'ın Kanlı Tılsımkârı" → "II. Mikołaj'ın"); q203_02a_rasputin_cemetery:102 (Rasputin'in "II. Nikolay Romanov'un sarayına" → "Mikołaj Romanov'un"); q301_03c_siergiej_ball:58 (Siergiej baloda "Çar Nikolay'ın huzuruna" → "Çar Mikołaj'ın"); q301_03i_siergiej_zofia:100 ("Mikolay Romanov'a danışmanlık" → "Mikołaj Romanov'a"); q302_03e_tsar_speech:65 Notes ("II. Mikolay 1895 konuşması" → "II. Mikołaj"); q302_03e_tsar_speech:192 (Çar Wiktor'a "saray tılsımkârı" ataması "Çar Mikolay Romanov" → "Çar Mikołaj Romanov"). **Rzeczpospolita aynen (1 yer):** lw_smg04_03a_university_leader:51 — Dickstein'ın üniversite konuşması "Cumhuriyet'in genç elitleri" → "Rzeczpospolita'nın genç elitleri" (proje %95 "Rzeczpospolita" özel ad olarak korunuyor — q301_02 yemin sahnesi, PP_readables, lw_smc03_readable hepsi). Pielgrzym/Tuziemiec (Hacı/Yerli) ve Cytadela (Sitadel) glossary tutarlı, sıfır sapma. Pak: 15.70 MB, deploy 03:59. |
| 2026-04-25 | On sekizinci tur — BarberDescription_ST + q104_05a Cytadela tutarlılığı | BarberDescription_ST 22 entry (saç/sakal stil edebi açıklamaları, dönem dili — quarter shingle, lwia grzywa, kaczy ogon, frenoloji, pikador, Dutch tarzı, deluxe pomada). q104_05a_konietchkin_and_cossac (109 satır — Konieczkin Wania ile Wiktor'u sorgu, Swietłana kayıp, "Quid pro quo" Latince). Çapraz "Kale Hapishanesi" tutarsızlık taraması. | **2 Cytadela tutarlılığı deploy'lu (2 dosya):** q104_05a_konietchkin_and_cossac:79 — Wania'nın Konieczkin'e sorusu "Onu **Kale'ye** götürüyor muyuz, amir bey?" → "Onu **Sitadel'e** götürüyor muyuz" (glossary ihlali; proje genelinde "Sitadel"). genenc_bzr_05:33 — Bazar Różyckiego mezar yağmacısı sahnesi "Ochrana masumları **Kale Hapishanesi'ne** götürmez" → "**Sitadel'e** götürmez" (eski PL "do Cytadeli" çevirisinde tutarsızlık). BarberDescription_ST ✅ temiz — 22 entry edebi dönem dili akıcı (sanatsal dağınıklık, frenoloji meraklıları, pikador bıyık, aslan yelesi, hayal gücüyle kıvrılmış pomada bıyık afrodizyak, gizem havası); yabancı stil adları (quarter shingle, Dutch, kaczy ogon→ördek kuyruğu) iyi aktarılmış. q104_05a sahnesi ✅ temiz — Konieczkin "amir bey" hitap (q104 ile q302 referans tutarlı), Quid pro quo Latince aynen, Swietłana Rumiancewa/Wisła/Wania doğru. Pak: 15.70 MB, deploy 04:03. |
| 2026-05-16 | Yirminci tur — v0.12.0 LW yan görev ana sahneleri + v0.12.1 lw_timeSkipScenes + DebugText_ST sonrası kapsamlı tarama | Yeni eklenen ~92 asset (84 LW main + 8 timeSkip) için glossary tutarlılık + tag dengesi + TR `...` taraması. Çapraz Grep: Pakt/Komiser/Polonyaca/Doktor/Hotel/Mikolaj/Car/Naczelnik/Cytadel/Berek. `validate_csv_columns.ps1` (0 ihlal), `validate_tag_balance.ps1` (1 önceden bilinen PL bug), `find_tr_triple_dots.ps1` (0). | **Sıfır yeni düzeltme:** Pakt → tutarlı Ant kullanımı (8 dosya, hepsi PL/Notes referans); Komiser → 5 dosya hepsi Pielewin "Komisarz" Rusça polis komiser unvanı (glossary "Amir≠Komiser" Naczelnik için, Komisarz değil); Polonyaca → 10 dosya bilinçli korunmuş (Lehçe vs Polonyaca özel ad/dil kullanımı uygun); Doktor → 7 dosya — gazete ilanı/POI prompt'unda "Doktor Jasiński" var, IC'de "Hekim Konstanty Jasiński" — küçük tutarsızlık ama context'e uygun (judgment call, düzeltme yok); Hotel Imperialny → özel ad korunmuş; Mikołaj diakritik → 0 sapma; Çar/Car → tutarlı; Naczelnik PL → yeni asset'lerde sıfır (regresyon yok); Cytadel → tutarlı. **84 yeni LW main scene + 8 timeSkip asset Tur 11-18'deki tüm pattern düzeltmelerini başarıyla taşıyor** (Pakt→Ant, Ohrana→Ochrana, Naczelnik→Amir, Mikolay→Mikołaj, …, Doktor→Hekim, Sitadel, Berek/Berk). Toplam: ~30.000 satır deploy, pak 19.90 MB. |
| 2026-05-15 | On dokuzuncu tur — otomatik validator taraması (tag dengesi + TR `...` + CSV bütünlüğü) | `validate_tag_balance.ps1` 8 ihlal raporladı; `find_tr_triple_dots.ps1` TR sütununda 19 ASCII `...` hit'i; `validate_csv_columns.ps1` temiz. Yeni vset asset partisi (BZR/CM/CYT/DS/PR/PRL/SMG/SMC/PP/PW + q104) Tur 12'den sonra eklendiği için üç nokta regresyonu birikmiş; PP_barber + q104_01e_bookmaker + PopupsTexts_ST'de Polonyaca argo terimleri tag içine alınmamıştı. | **27 düzeltme deploy'lu (20 dosya):** **Tag dengesi (4 yer / 4 dosya):** PopupsTexts_ST [Q102Demo_StartBoard] — TR `<b>1905 Varşova'sının</>` → `</b>` (PL ile birebir kapanış formatı); PP_barber [B2D116A6] — `<i>majchrować</>` (argo: ustura sallamak) TR'de düz "ustura çekmeye" → `ustura <i>çekmeye</>` (argo italik vurgu); PP_barber [527F922E] — `<dl>nazad</>` (Rus-Pol argosu, yeniden) TR'de düz "yeniden" → `<dl>yine</> <dl>parlak herif</>`; q104_01e_bookmaker [A86B2063] — `<dl>Mantyczenie</>` (argo: can sıkıntısı) TR'de tag tamamen kayıp + "Keyif kaçıyor" anlam zayıf → `<dl>Sıkıntı</> mı bastı?`. **Glossary (1 yer):** pr_vset_patient_m_01 [627E89D5] — `<i>Konował</>` PL form kalmıştı (glossary `konował → şarlatan`, genenc_pr_02 referans) → `<i>Şarlatan</>`. **TR `...` → `…` toplu (19 yer / 16 dosya):** `scripts/fix_tr_triple_dots.ps1` — yeni vset asset'leri (bzr/cm/CYT/DS/pr/prl/q104/smg/vset_coachman). **Kalan:** q201b_01b_smugglers_talk [5158C00D] — PL kaynak typo'su `>dl>skrewili</>` (`<` yerine `>`); TR semantik olarak doğru (2 `<dl>` zaten anlamı taşıyor), düzeltme yok. **Validate sonrası:** tag dengesi 8→1 (PL bug), TR `...` 19→0, CSV bütünlüğü 0. Pak: 15.45 MB, deploy ~22:15. |
